        ...
        if collisions:
            for obj in collisions:
                if isinstance(obj, block.Block):  # Check if the object is a block
                    ...
                    if (self.player.rect.right > obj.rect.left and self.player.rect.left < obj.rect.left and self.player.dir == "right"):
                    ...
                    if (self.player.rect.left < obj.rect.right and self.player.rect.right > obj.rect.right and self.player.dir == "left"):
                        if not self.player.is_jumping:
                            self.player.is_stopped = True
                ...
                if isinstance(obj, ramp.Ramp):
                    if self.player.dir == obj.dir:
                        # self.player.rect.bottom = obj.rect.top
                        self.player.x_vel = self.player.max_speed * self.player.grind_speed
